...
public class productoController {
    ...
    public Map<String, String> uploadFile(@RequestParam("file") MultipartFile multipartFile, @RequestParam("nombre") String nombre, @RequestParam Integer precio ){
        
        String url;
        
        String path = productoServicio.almacenarImagen(multipartFile);
